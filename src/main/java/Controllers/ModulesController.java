...
public class ModulesController {
    ...
    public void handleDashboard(MouseEvent event) {
        naviguerVers("Dashboard.fxml", (Node) event.getSource());
    }
    ...
    @FXML public void handleQuiz(MouseEvent event)         { System.out.println("Quiz"); }
    ...
    @FXML public void handleProfil(MouseEvent event)       { System.out.println("Profil"); }
