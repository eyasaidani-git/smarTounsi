...
public class EvenementService implements IService<Evenement> {
    ...
    public void add(Evenement e) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)) {
            ...
            if (e.getTypeEvenement() == null) {
                ps.setString(3, EvenementType.AUTRE.name());
            } else {
    ...
    public List<Evenement> getByType(EvenementType type) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            System.out.println("Erreur getByType événement : " + ex.getMessage());
        }
    ...
    public List<Evenement> getByStatut(String statut) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            System.out.println("Erreur getByStatut événement : " + ex.getMessage());
        }
    ...
    public void changerStatut(int idEvenement, String nouveauStatut) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            System.out.println("Statut événement modifié avec succès.");

        } catch (SQLException ex) {
            System.out.println("Erreur changerStatut événement : " + ex.getMessage());
        }
    }
    ...
    public List<Evenement> rechercher(String motCle) {
        ...
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
            ...
            System.out.println("Erreur rechercher événement : " + ex.getMessage());
        }
